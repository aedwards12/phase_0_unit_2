...
=begin
I had considerable amount of trouble with this challenge because using rspec and irb produced 2 different results
irb would pass all the tests and rspec would not. I think I need to do more research on this issue im having. 
I had to do research on sort_by method. I did learn a valuable difference between the 2 methods of sort and sort_by
I also learned alittle bit more about arrays and hashes. I didn't love this challenge it was just okay and a little 
frustrating that both compilers where giving me problems. 	
=end
